...
//   let parsedNumber = parseInt(phoneNumber);

//   let newUser = new users(firstName, lastName, parsedNumber);
//   userArray.push(newUser);
//   console.log(userArray);

//     table.innerHTML += `<tr> <td> ${firstName} </td> <td> ${lastName} </td> <td> ${parsedNumber} </td>`;
// });
...
// 12 `Make a TODO app for yourself. You should have only one input and “Add” button. After clicking on the Add button, display the newly added task that you need to do in an unordered list. Each new todo should be saved into an array.
...
addButton.addEventListener("click", function () {
  ...
  let newinput = new userInput(input);
